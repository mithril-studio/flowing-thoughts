    ...
    <div className="h-full space-y-4 overflow-y-auto px-4 py-4">
      ...
      <Section title="Transcription">
        ...
        <div className="space-y-2 pt-1">
          <p className="text-xs text-zinc-400">Local models</p>
                ...
                <div className="flex items-center justify-between gap-2">
                  <div className="min-w-0">
                    <div className="flex items-center gap-1.5">
                      <p className="truncate text-sm text-zinc-200">{model.display_name}</p>
                      {model.multilingual && (
                        <span className="shrink-0 rounded-full border border-sky-800 bg-sky-950/60 px-1.5 py-px text-[9px] font-medium uppercase tracking-wide text-sky-300">
                          EN + NL
                        </span>
                      )}
                    </div>
                  ...
                  <div className="flex shrink-0 items-center gap-1.5">
                    {model.installed ? (
                      <>
                        {isSelected ? (
                          <span className="rounded-lg bg-emerald-900/60 px-2.5 py-1.5 text-xs text-emerald-300">
                            Active
                          </span>
                        ) : (
                          <button
                            ...
                            className="rounded-lg border border-zinc-700 px-2.5 py-1.5 text-xs text-zinc-200 hover:bg-zinc-800"
                          >
                            Use
                          </button>
                        )}
                        <button
                          ...
                          className="rounded-lg px-2 py-1.5 text-xs text-zinc-500 hover:bg-red-950/40 hover:text-red-300"
                        >
                          Delete
                        </button>
                      </>
                      ...
                      <button
                        ...
                        className="rounded-lg border border-zinc-700 px-2.5 py-1.5 text-xs text-zinc-200 hover:bg-zinc-800 disabled:opacity-60"
                      >
      ...
      <Section title="General">
        ...
        />
        <div className="space-y-1">
          <p className="text-xs text-zinc-400">Window position</p>
          <select
      ...
      <Section title="Cloud API (optional)">
        <p className="text-xs text-zinc-500">
          Only needed when Transcription is set to Cloud API.
        </p>
        ...
        <div className="space-y-2">
          <p className="text-xs text-zinc-400">Edit key for</p>
          <div className="grid grid-cols-2 gap-2">
            {(Object.keys(PROVIDER_META) as Provider[]).map((key) => {
        ...
        <a
          ...
          className="block text-[11px] text-zinc-500 underline hover:text-zinc-300"
        >
          How to get a {editingMeta.label} API key →
        </a>
        {apiMessage && <p className="text-xs text-zinc-300">{apiMessage}</p>}
      </Section>
      ...
      <Section title="About">
        <div className="space-y-2 rounded-xl border border-zinc-800 bg-zinc-950/80 p-3">
          <div className="flex items-center justify-between gap-2">
            <div className="min-w-0">
              <p className="text-sm text-zinc-200">FlowingThoughts</p>
          ...
          <div className="flex items-center justify-between gap-2 pt-1">
            ...
            {updateStatus === "available" ? (
              ...
              <button
                ...
                className="rounded-lg border border-zinc-700 bg-zinc-900 px-3 py-1 text-xs text-zinc-200 hover:bg-zinc-800 disabled:opacity-50"
              >
...
function SecondaryButton({
  ...
  return (
    <button
      ...
      onClick={onClick}
      disabled={disabled}
      className="rounded-lg border border-zinc-700 bg-zinc-900 px-3 py-2 text-sm text-zinc-200 hover:bg-zinc-800 disabled:opacity-60"
    >
      {children}
    </button>
  );
...
function ProviderTile({
  ...
  return (
    ...
    >
      <p className={`text-sm font-medium ${selected ? "text-emerald-300" : "text-zinc-200"}`}>
        {title}
      </p>
